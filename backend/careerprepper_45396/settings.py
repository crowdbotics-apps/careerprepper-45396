"""
Django settings for careerprepper_45396 project.
...
ROOT_URLCONF = 'careerprepper_45396.urls'
...
WSGI_APPLICATION = 'careerprepper_45396.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "careerprepper_45396 API",
    "DESCRIPTION": "API documentation for careerprepper_45396 App",
    "VERSION": "v1",
}
